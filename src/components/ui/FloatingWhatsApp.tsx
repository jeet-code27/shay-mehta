...
export function FloatingWhatsApp({
  phoneNumber = "919217730039",
  message = "Hi Shay, I visited your portfolio and would like to connect!",
  ...
  return (
    ...
    >
      {/* Neo-brutalist Label Pill */}
      <a
        href={whatsappUrl}
        target="_blank"
        rel="noopener noreferrer"
        className="hidden sm:inline-flex items-center gap-2 bg-white text-foreground font-heading font-bold text-xs md:text-sm px-4 py-2 rounded-full border-2 border-foreground shadow-[3px_3px_0px_0px_#1E293B] transition-all duration-300 group-hover:-translate-x-1 group-hover:-translate-y-0.5 group-hover:shadow-[5px_5px_0px_0px_#1E293B] select-none"
      >
        <span className="relative flex h-2.5 w-2.5">
          <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#1BD741] opacity-75"></span>
          <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[#1BD741] border border-foreground"></span>
        </span>
        <span>Chat with Shay</span>
      </a>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Chat on WhatsApp with Shay Mehta"
        className="relative w-14 h-14 md:w-16 md:h-16 rounded-full bg-white border-2 border-foreground shadow-[4px_4px_0px_0px_#1E293B] flex items-center justify-center transition-all duration-300 hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[6px_6px_0px_0px_#1E293B] active:translate-x-0 active:translate-y-0 active:shadow-[2px_2px_0px_0px_#1E293B] group-hover:scale-105"
      >
        {/* Exact User Provided WhatsApp SVG */}
        <svg
          version="1.1"
          id="Layer_1"
          ...
          viewBox="0 0 470 470"
          xmlSpace="preserve"
          className="w-9 h-9 md:w-10 md:h-10 transition-transform duration-300 group-hover:rotate-6"
        >
          <g>
            <g>
              <path
                style={{ fill: "#1BD741" }}
                d="M170,430L45,460l37.5-83.398C43.902,337.695,20,284.102,20,225c0-118.701,96.299-215,215-215
            ...
            <g>
              <g id="XMLID_21_">
                <path
                  style={{ fill: "#FFFFFF" }}
                  d="M342.002,282.598l-49.404-49.497c-3.994-3.901-10.293-3.901-14.199,0l-21.201,21.196
                ...
                <g>
                  <path
                    style={{ fill: "#231F20" }}
                    d="M235,0C110.935,0,10,100.935,10,225c0,57.486,21.471,111.785,60.607,153.666L35.88,455.899
                  ...
                  <path
                    style={{ fill: "#231F20" }}
                    d="M299.676,226.036c-0.03-0.03-0.06-0.06-0.09-0.089c-3.811-3.722-8.825-5.772-14.12-5.772
